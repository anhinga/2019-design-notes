...
(e.g. mouse clicks, see Section 6.3 of the reference paper above). 
...
In our software experiments, we used self-modification facilities to
  ...
  \begin{itemize}
     ...
     \item edit a running network on the fly by sending it requests to edit itself (in particular, this enables {\bf livecoding}, see Section 1.1 of our 11-2018 technical report, \href{https://www.cs.brandeis.edu/~bukatin/dmm-notes-2018.pdf}{\tt dmm-notes-2018.pdf}).
  \end{itemize}
