...
During network "stop the world, expand the world, resume the world" occasional adjustment, slots produced by zero neurons can be filled; however the existing "non-linear wiring" must remain untouched.
